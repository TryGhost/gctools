...
import setCanonicalUrl from '../commands/set-canonical-url.js';
import cleanSlugs from '../commands/clean-slugs.js';
import cleanStaffSlugs from '../commands/clean-staff-slugs.js';
...
prettyCLI.command(setCanonicalUrl);
prettyCLI.command(cleanSlugs);
prettyCLI.command(cleanStaffSlugs);
