...
import deleteEmptyTagsCommands from '../commands/delete-empty-tags.js';
...
import fetchImagesCommands from '../commands/fetch-images.js';
...
prettyCLI.command(deleteEmptyTagsCommands);
...
prettyCLI.command(fetchImagesCommands);
