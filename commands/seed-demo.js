...
const desc =
    'Seed a Ghost site with rich demo content (posts, images, tags, an about page, a style guide, and navigation). Use a staff access token to update navigation.';
...
const run = async (argv) => {
    ...
    try {
        ...
        ui.log.error(
            'Done with errors',
            context.errors && context.errors.length ? context.errors : [error],
        );
        return;
    }
