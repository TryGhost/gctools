...
const fixturePath = fileURLToPath(
    new URL('./fixtures/update-posts-from-json.json', import.meta.url),
);
...
const ghostPosts = [
    {
        ...
        tags: [],
        authors: [{ id: 'gb', slug: 'bob', email: 'bob@example.com', name: 'Bob' }],
    },
    {
        id: 'p2',
        slug: 'post-two',
        ...
        updated_at: '2024-01-01T00:00:00.000Z',
        tags: [],
        authors: [{ id: 'ga', slug: 'alice', email: 'alice@example.com', name: 'Alice' }],
    },
    {
        id: 'p3',
        slug: 'post-three',
    ...
    },
    {
        ...
        slug: 'post-four',
        title: 'Post Four',
        url: 'https://example.com/post-four/',
        updated_at: '2024-01-01T00:00:00.000Z',
        tags: [],
        authors: [{ id: 'ga', slug: 'alice', email: 'alice@example.com', name: 'Alice' }],
    },
...
describe('update-posts-from-json', function () {
    ...
    test('exposes Authors as an updatable field', async function () {
        ...
        assert.ok(
            updatePostsFromJson.UPDATABLE_FIELDS.some(
                (f) => f.name === 'Authors' && f.value === 'authors',
            ),
        );
    });
    ...
    test('updates authors by email, only when they differ from Ghost', async function () {
        ...
        // post-one: [bob] → [alice]
        assert.deepStrictEqual(editCallFor('p1').arguments[0].authors, [
